      ...
      <div className="container mx-auto">
        <div className="flex flex-col gap-y-[30px] xl:flex-row xl:gap-x-[30px]">
          ...
          <div className="flex flex-col gap-y-[30px] w-full max-w-lg mx-auto h-[500px]">
            <Promo
              promoText="Save 35% all dslr cameras"
              promoImg={PromoImg1}
              linkText="Shop now"
            />
            <Promo
              promoText="Save 25% all mirrorless cameras"
              promoImg={PromoImg2}
              linkText="Shop now"
            />
          </div>
...
const Promo = ({ promoText, linkText, promoImg }) => {
  return (
    <div className="grad flex-1 h-[250px] rounded-[8px] overflow-hidden relative p-6">
      ...
      <img className="absolute z-20 -top-4 -right-6" src={promoImg} alt="" />
    </div>
  );
};
